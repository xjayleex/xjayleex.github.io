...
&ensp;&ensp;&ensp;[**For**](#for)  
&ensp;&ensp;&ensp;[**Switch**](#switch)  
&ensp;&ensp;&ensp;[**Type Switch**](#type-switch)  
[**Function**](#function)  
&ensp;&ensp;&ensp;[**Named result parameters**](#named-result-parameters)  
&ensp;&ensp;&ensp;[**Defer**](#defer)  
[**Data**](#data)  
&ensp;&ensp;&ensp;[**Allocation with New**](#allocation-with-new)  
&ensp;&ensp;&ensp;[**Constructor and Composite literal**](#constructor-and-composite-literal)  
&ensp;&ensp;&ensp;[**Allocation with Make**](#allocation-with-make)  
&ensp;&ensp;&ensp;[**Array**](#array)  
&ensp;&ensp;&ensp;[**Slices**](#slices)  
&ensp;&ensp;&ensp;[**Two Dimensional Slice**](#two-dimensional-slice)  
&ensp;&ensp;&ensp;[**Map**](#map)  
&ensp;&ensp;&ensp;[**Append**](#append)  
[**Initialization**](#initialization)  
&ensp;&ensp;&ensp;[**Constants**](#constants)  
&ensp;&ensp;&ensp;[**Variable**](#variable)  
&ensp;&ensp;&ensp;[**The init function**](#the-init-function)  
[**Method**](#method)  
&ensp;&ensp;&ensp;[**Pointers vs. Values**](#pointers-vs.-values)  
[**Interface and other types**](#interface-and-other-types)  
&ensp;&ensp;&ensp;[**Interface**](#interface)  
&ensp;&ensp;&ensp;[**Conversions**](#conversions)  
&ensp;&ensp;&ensp;[**Interface conversions and type assertions**](#interface-conversions-and-type-assertions)  
&ensp;&ensp;&ensp;[**Generality**](#generality)  
&ensp;&ensp;&ensp;[**Interfaces and methods**](#interfaces-and-methods)  
[**The blank identifier**](#the-blank-identifier)  
&ensp;&ensp;&ensp;[**The blank identifier in multiple assignment**](#the-blank-identifier-in-multiple-assignment)  
&ensp;&ensp;&ensp;[**Unused imports and variables**](#unused-imports-and-variables)  
&ensp;&ensp;&ensp;[**Import for side effect**](#import-for-side-effect)  
&ensp;&ensp;&ensp;[**Interface checks**](#interface-checks)  
[**Embedding**](#embedding)  
[**Errors**](#errors)  
&ensp;&ensp;&ensp;[**Panic**](#panic)  
&ensp;&ensp;&ensp;[**Recover**](#recover)  
[**Concurrency**](#concurrency)  
&ensp;&ensp;&ensp;[**Share by communicating**](#share-by-communicating)  
&ensp;&ensp;&ensp;[**Goroutines**](#goroutines)  
&ensp;&ensp;&ensp;[**Channels**](#channels)  
&ensp;&ensp;&ensp;[**Channels of channels**](#channels-of-channels)  
&ensp;&ensp;&ensp;[**Parallelization**](#parallelization)  
...
## Errors
---
Library routine은 에러 징후가 보인다면 caller에게 자주 리턴해주어야 한다. 이전에 언급했듯, Go의 Multivalue return은 상세한 에러 내용을 제공하기 쉽게 한다. 예로써, `os.Open`은 fail시 `nil`뿐만 아니라, 무엇이 잘못되었는지에 대한 에러 내용도 리턴한다.   
`라이브러리 루틴은 일반적으로 발생하는 문제나 작업을 처리하도록 설계된 디버깅된 code block(subroutines, procedure, function).`
